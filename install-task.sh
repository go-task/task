#!/bin/sh
set -e
# Code generated by godownloader on 2026-08-03T13:40:40Z. DO NOT EDIT.
#
...
tag_to_version() {
  ...
  if test -z "$REALTAG"; then
    log_crit "unable to find '${TAG}' - use 'latest' or see https://github.com/pathum25 ${PREFIX}/releases for details"
    exit 1
  fi

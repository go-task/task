...
require (
	...
	github.com/goreleaser/godownloader v0.0.0-20190115105928-9286de539a62 // indirect
	github.com/goreleaser/goreleaser v0.99.0 // indirect
	...
	golang.org/x/build v0.0.0-20190125231735-47e1a6101d0b // indirect

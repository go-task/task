...
Once [installed](installation.mdx), you just need to describe your build tasks
...
- [Easy installation](installation.mdx): just download a single binary, add to
  `$PATH` and you're done! Or you can also install using [Homebrew][homebrew],
  [Snapcraft][snapcraft], or [Scoop][scoop] if you want.
- Available on CIs: by adding
  [this simple command](installation.mdx#install-script) to install on your CI

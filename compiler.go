	...
	getRangeFunc := func(dir string) func(k string, v ast.Var) error {
		return func(k string, v ast.Var) error {
			...
			if newVar.Value != nil || newVar.Sh == nil {
				result.Set(k, ast.Var{Value: newVar.Value, Sh: newVar.Sh, Interactive: newVar.Interactive})
				return nil
			}
			...
			result.Set(k, ast.Var{Value: static, Sh: newVar.Sh, Interactive: newVar.Interactive})
			return nil
		}
	}

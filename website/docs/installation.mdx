...
If you're on Arch Linux you can install Task from the package manager:
...
[this package](https://aur.archlinux.org/packages/go-task) which builds and installs
from the latest commit from the
